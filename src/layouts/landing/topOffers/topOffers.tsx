        ...
        >
          <div className='w-full flex flex-col items-start justify-start'>
            <span className="inline-block">
              <HeadingText styles="mb-5 lg:text-[44px] md:text-[34px] text-[24px]">Top offers</HeadingText>
            </span>

            <span className="inline-block max-w-[611px]">
              <ParagraphText styles="mb-[50px] lg:text-[22px] sm:text-[16px] text-sm">
          ...
          <div className="w-full hidden md:flex items-center justify-center gap-5">
            {images.map((elem, index) => <PropertyCard key={index} img={elem.img} />)}
          </div>
        </div>
      </div>
    </section>
